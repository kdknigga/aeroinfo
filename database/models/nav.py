...
class Navaid(Base):
    ...
    city = Column(String(40), primary_key=True)
...
class Remark(Base):
    ...
    __table_args__ = (ForeignKeyConstraint([facility_id, facility_type], [Navaid.facility_id, Navaid.facility_type]), {})
...
class VORReceiverCheckpoint(Base):
    ...
    air_ground = Column(Enum(enums.VORReceiverCheckpointAirGroundCodeEnum), primary_key=True)
