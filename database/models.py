...
class Airport(Base):
    ...
    def to_dict(self, include=None):
        ...
        ownership_attrs = ["ownership_type", "ownership_type_remark",
            "facility_use", "facility_use_remark", "owners_name",
            "owners_name_remark", "owners_address", "owners_address_remark",
            "owners_city_state_zip", "owners_city_state_zip_remark",
            "owners_phone", "owners_phone_remark", "managers_name",
            "managers_name_remark", "managers_address",
            "managers_address_remark", "managers_city_state_zip",
            "managers_city_state_zip_remark", "managers_phone",
            "managers_phone_remark"]

        geo_attrs = ["latitude_dms", "latitude_dms_remark", "latitude_secs",
        ...
        fedstatus_attrs = ["activation_date", "status", "arff_certification",
            ...
            "military_civil_join_use_remark", "military_landing_rights",
        ...
        aptsrv_attrs = ["fuel_available", "fuel_available_remark",
            ...
            "power_plant_repair_service", "power_plant_repair_service_remark",
            "bottled_oxygen", "bottled_oxygen_remark", "bulk_oxygen",
            "bulk_oxygen_remark"]

        facilities_attrs = ["lighting_schedule", "lighting_schedule_remark",
            "beacon_schedule", "beacon_schedule_remark", "towered_airport",
            "unicom", "unicom_remark", "ctaf", "ctaf_remark",
            "segmented_circle_available", "segmented_circle_available_remark",
            "beacon_color", "beacon_color_remark", "noncommerical_landing_fee",
        ...
        basedacft_attrs = ["based_general_aviation_single_engine_airplanes",
            ...
            "based_general_aviation_helicopters_remark", "based_gliders",
            "based_gliders_remark", "based_military_aircraft",
            "based_military_aircraft_remark", "based_ultralight_aircraft",
            "based_ultralight_aircraft_remark"]

        annops_attrs = ["annual_ops_commercial", "annual_ops_commercial_remark",
            "annual_ops_commuter", "annual_ops_air_taxi",
            ...
            "annual_ops_military", "annual_ops_military_remark",
            "annual_ops_end_of_measurement_period"]

        addl_attrs = ["position_source", "position_date", "elevation_source",
            "elevation_date", "contract_fuel_available",
            "transient_storage_facilities",
            "transient_storage_facilities_remark", "other_services_available",
            "other_services_available_remark", "wind_indicator",
            "wind_indicator_remark", "minimum_operational_network"]
...
class Runway(Base):
    ...
    def to_dict(self, include=None):
        ...
        base_attrs = ["name", "name_remark", "length", "length_remark",
            "width", "width_remark", "surface_type_condition",
            "surface_type_condition_remark", "surface_treatment",
            "surface_treatment_remark", "pavement_classification_number",
            "pavement_classification_number_remark", "edge_light_intensity",
            "edge_light_intensity_remark"]

        addl_attrs = ["length_source", "length_source_date",
...
class RunwayEnd(Base):
    ...
    def to_dict(self, include=None):
        ...
        base_attrs = ["id", "id_remark", "true_alignment",
            "true_alignment_remark", "approach_type", "right_traffic",
            "right_traffic_remark", "markings_type", "markings_remark",
            "markings_condition"]

        geo_attrs = ["latitude_dms", "latitude_dms_remark", "latitude_secs",
            "longitude_dms", "longitude_dms_remark", "longitude_secs",
            "elevation", "elevation_remark", "threshold_crossing_height",
            "threshold_crossing_height_remark", "visual_glide_path_angle",
            ...
            "displaced_threshold_elevation", "displaced_threshold_length",
            "displaced_threshold_length_remark", "touchdown_zone_elevation"]
        ...
        obj_attrs = ["controlling_object_description",
            "controlling_object_description_remark",
            "controlling_object_marking", "controlling_object_marking_remark",
            "part77_category", "part77_category_remark",
        ...
        addl_attrs = ["gradient", "gradient_remark", "gradient_direction",
            "position_source", "position_date", "elevation_source",
            "elevation_date", "displaced_threshold_position_source",
            "displaced_threshold_position_date",
            "displaced_threshold_elevation_source",
            "displaced_threshold_elevation_date",
            "touchdown_zone_elevation_source", "touchdown_zone_elevation_date",
            "takeoff_run_available", "takeoff_run_available_remark",
            "takeoff_distance_available", "accelerate_stop_distance_available",
...
class AirportRemark(Base):
    ...
    def __repr__(self):
        return "<Airport Remark(airport='%s', element_name='%s', remark='%s...')>" % (self.airport, self.remark_element_name, self.remark[:13])
...
class RunwayRemark(Base):
    ...
    def __repr__(self):
        return "<Runway Remark(runway='%s', element_name='%s', remark='%s...')>" % (self.runway, self.remark_element_name, self.remark[:13])
