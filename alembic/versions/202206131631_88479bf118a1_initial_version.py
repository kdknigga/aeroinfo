...
def upgrade():
    ...
    op.create_table(
        "airports",
        sa.Column(
            "facility_site_number", sa.String(length=11), nullable=False
        ),
        ...
        sa.Column(
            "ownership_type",
            sa.Enum(
                "PU", "PR", "MA", "MN", "MR", "CG", name="ownershiptypeenum"
            ),
            nullable=True,
        ),
        sa.Column(
            "ownership_type_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column(
            "facility_use",
        ...
        sa.Column(
            "facility_use_remark", sa.String(length=1500), nullable=True
        ),
        ...
        sa.Column(
            "owners_address_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column(
            "owners_city_state_zip", sa.String(length=45), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "owners_phone_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column("managers_name", sa.String(length=35), nullable=True),
        sa.Column(
            "managers_name_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column("managers_address", sa.String(length=72), nullable=True),
        sa.Column(
            "managers_address_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column(
            "managers_city_state_zip", sa.String(length=45), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "coords_method_remark", sa.String(length=1500), nullable=True
        ),
        ...
        sa.Column(
            "distance_from_city_remark", sa.String(length=1500), nullable=True
        ),
        ...
        sa.Column(
            "boundary_artcc_computer_id", sa.String(length=3), nullable=True
        ),
        ...
        sa.Column(
            "responsible_artcc_computer_id", sa.String(length=3), nullable=True
        ),
        sa.Column(
            "responsible_artcc_name", sa.String(length=30), nullable=True
        ),
        ...
        sa.Column(
            "arff_certification_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column(
            "npias_federal_agreements", sa.String(length=7), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "airspace_analysis_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column("airport_of_entry", sa.Boolean(), nullable=True),
        sa.Column(
            "airport_of_entry_remark", sa.String(length=1500), nullable=True
        ),
        ...
        sa.Column(
            "inspection_method",
            sa.Enum(
                "F", "S", "C", "O", "T", name="airportinspectionmethodenum"
            ),
            nullable=True,
        ),
        sa.Column(
        ...
        sa.Column(
            "last_information_request_complete_date", sa.Date(), nullable=True
        ),
        sa.Column("fuel_available", sa.String(length=40), nullable=True),
        sa.Column(
            "fuel_available_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column(
            "airframe_repair_service", sa.String(length=5), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "power_plant_repair_service", sa.String(length=5), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "bottled_oxygen_remark", sa.String(length=1500), nullable=True
        ),
        ...
        sa.Column(
            "lighting_schedule_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column("beacon_schedule", sa.String(length=7), nullable=True),
        sa.Column(
            "beacon_schedule_remark", sa.String(length=1500), nullable=True
        ),
        ...
        sa.Column(
            "beacon_color_remark", sa.String(length=1500), nullable=True
        ),
        ...
        sa.Column(
            "based_general_aviation_helicopters", sa.Integer(), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "based_gliders_remark", sa.String(length=1500), nullable=True
        ),
        ...
        sa.Column(
            "annual_ops_commuter_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column("annual_ops_air_taxi", sa.Integer(), nullable=True),
        sa.Column(
            "annual_ops_air_taxi_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column(
            "annual_ops_general_aviation_local", sa.Integer(), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "annual_ops_military_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column(
            "annual_ops_end_of_measurement_period", sa.Date(), nullable=True
        ),
        ...
        sa.Column(
            "transient_storage_facilities", sa.String(length=12), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "other_services_available", sa.String(length=71), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "wind_indicator_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column("icao_id", sa.String(length=7), nullable=True),
        sa.Column(
            "minimum_operational_network", sa.String(length=1), nullable=True
        ),
        sa.PrimaryKeyConstraint("facility_site_number"),
    )
    op.create_index(
        op.f("ix_airports_faa_id"), "airports", ["faa_id"], unique=False
    )
    op.create_index(
        op.f("ix_airports_icao_id"), "airports", ["icao_id"], unique=False
    )
    op.create_table(
        "airport_remarks",
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "surface_type_condition", sa.String(length=12), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "surface_treatment_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "true_alignment_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column("approach_type", sa.String(length=10), nullable=True),
        sa.Column("right_traffic", sa.Boolean(), nullable=True),
        sa.Column(
            "right_traffic_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column(
            "markings_type",
            sa.Enum(
        ...
        sa.Column(
            "visual_glide_path_angle", sa.Float(precision=2), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "touchdown_zone_elevation", sa.Float(precision=1), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "rvr_equipment_remark", sa.String(length=1500), nullable=True
        ),
        ...
        sa.Column(
            "reil_availability_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column(
            "centerline_light_availability", sa.Boolean(), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "touchdown_lights_availability", sa.Boolean(), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "part77_category_remark", sa.String(length=1500), nullable=True
        ),
        sa.Column(
            "controlling_object_clearance_slope", sa.Integer(), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "displaced_threshold_position_date", sa.Date(), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "displaced_threshold_elevation_date", sa.Date(), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "accelerate_stop_distance_available", sa.Integer(), nullable=True
        ),
        ...
        sa.Column(
            "description_of_lahso_entity", sa.String(length=40), nullable=True
        ),
